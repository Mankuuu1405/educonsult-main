...
const EditProfileF = ({ profileData, setProfileData, onSubmit }) => {
  ...
  const handleImageUpload = (e) => {
    ...
    if (file.size > MAX_FILE_SIZE_KB * 1024) {
      addToast(
        `File is too large! Please select an image smaller than ${MAX_FILE_SIZE_KB} KB.`,
        "error"
      );
      e.target.value = null;
      return;
  ...
  const handleRemoveTag = (tagToRemove) => {
    setProfileData((prev) => ({
      ...prev,
      expertiseTags: (prev.expertiseTags || []).filter(
        (tag) => tag !== tagToRemove
      ),
    }));
  };
  ...
  return (
    <div className="grid lg:grid-cols-5 gap-12">
        ...
        <form onSubmit={onSubmit}>
          ...
          <div className={`space-y-6 ${activeTab !== "profile" && "hidden"}`}>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="relative">
                  <BriefcaseIcon className="w-5 h-5 absolute left-4 top-1/2 -translate-y-1/2 text-gray-400" />
                  <input
                    name="title"
                    type="text"
            ...
            <div>
              ...
              <div className="relative">
                <AcademicCapIcon className="w-5 h-5 absolute left-4 top-1/2 -translate-y-1/2 text-gray-400" />
                <input
                  name="education"
                  type="text"
              ...
              >
                ...
                <div className="ml-4">
                  ...
                  <p className="text-sm text-gray-500">
                    Toggle this on to show you are available for immediate
                    sessions.
                  </p>
                </div>
              </label>
          ...
          <div className={`space-y-6 ${activeTab !== "financial" && "hidden"}`}>
            <div>
              ...
              <select
                id="payoutMethod"
                name="financials.payoutMethod"
                value={profileData.financials?.payoutMethod || "paypal"}
                onChange={handleInputChange}
            ...
            {profileData.financials?.payoutMethod === "paypal" && (
              <div>
                ...
                <div className="relative">
                  <AtSymbolIcon className="w-5 h-5 absolute left-4 top-1/2 -translate-y-1/2 text-gray-400" />
                  <input
                    name="financials.paypalEmail"
                    type="email"
                    value={profileData.financials?.paypalEmail || ""}
                    onChange={handleInputChange}
                    className="w-full pl-12 pr-4 py-3 border rounded-lg"
            ...
            {profileData.financials?.payoutMethod === "bank" && (
              <div className="space-y-4 p-4 border rounded-lg bg-slate-50">
                ...
                <div>
                  ...
                  <input
                    name="financials.bankAccountName"
                    type="text"
                    value={profileData.financials?.bankAccountName || ""}
                    onChange={handleInputChange}
                    required
                ...
                <div>
                  ...
                  <input
                    name="financials.bankAccountNumber"
                    type="text"
                    value={profileData.financials?.bankAccountNumber || ""}
                    onChange={handleInputChange}
                    required
                    className="w-full px-4 py-2 border rounded-md"
                  />
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      name="financials.branchName"
                      type="text"
                      value={profileData.financials?.branchName || ""}
                      onChange={handleInputChange}
                      className="w-full px-4 py-3 border rounded-lg"
                ...
                <div>
                  ...
                  <input
                    name="financials.bankRoutingNumber"
                    type="text"
                    value={profileData.financials?.bankRoutingNumber || ""}
                    onChange={handleInputChange}
                    required
                    className="w-full px-4 py-2 border rounded-md"
                  />
                ...
                <div>
                  ...
                  <input
                    name="financials.bankIfscCode"
                    type="text"
                    value={profileData.financials?.bankIfscCode || ""}
                    onChange={handleInputChange}
                    required
                    className="w-full px-4 py-2 border rounded-md"
                  />
          ...
          <div className="pt-6 mt-6 border-t">
            <button
              type="submit"
              className="w-full flex items-center justify-center bg-indigo-600 text-white font-bold py-3 px-4 rounded-lg hover:bg-indigo-700 transition-transform transform hover:scale-105"
            >
      ...
      <div
        ref={cardRef}
        className="lg:col-span-2 flex items-center justify-center h-full"
      >
        <div
          className="w-full max-w-sm bg-slate-800 rounded-2xl shadow-2xl p-8 text-center"
        ...
        >
          <div className="relative inline-block">
            <img
              ...
              alt="Profile"
              className="h-32 w-32 rounded-full object-cover border-4 border-indigo-400 shadow-lg"
            />
            <label
              htmlFor="profile-upload"
              className="absolute -bottom-2 -right-2 bg-white p-2 rounded-full cursor-pointer shadow-md hover:bg-gray-200 transition-colors"
            >
          ...
          <p className="text-sm text-slate-400 mt-4 text-center max-w-xs mx-auto">
            {profileData.bio}
          </p>
            ...
            <div className="flex flex-wrap justify-center gap-2">
              {profileData.expertiseTags &&
                profileData.expertiseTags.map((tag) => (
                  <span
                    key={tag}
                    className="bg-indigo-500/20 text-indigo-200 text-xs font-medium px-2.5 py-1 rounded-full"
                  >
                    {tag}
                  </span>
                ))}
